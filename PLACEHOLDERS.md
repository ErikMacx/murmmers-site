...
- **Book descriptions** (19 of 23): `src/data/books.json` carries a marked placeholder per book. Each needs a one-line description in press voice. Written so far: The Petrosphere Odyssey and the three Waking books.
- **Amazon listing URLs** (19 published books): `amazon_url` is empty pending ASINs. Each book page's Amazon buy link is inert until these land. The Petrosphere Odyssey is excluded (see below).
- **Themes** (all 20): `themes` is an empty array per book, for the publisher to fill.

## Covers

- **The Petrosphere Odyssey, interim cover**: the Vellum export carries no cover image, so the cover shown is page one of the source Print PDF (`~/Documents/ALL COMPLETE VELLUM BOOKS/The Petrosphere Odyssey/Print/The-Petrosphere-Odyssey-Print-2026-07-08.pdf`), rendered at 1035x1600 with qlmanage. It is a stand-in only; a proper cover replaces it through the stage 50 cover workstream.
...
- **Homepage features five**: The Petrosphere Odyssey, Welcome Home, Spiral MasterWorks, Cathedral, Coherence. **The Healing is deliberately not featured on the homepage**, though it is a flagship-tier lead. Reason: a second, distinct book also titled The Healing launches later this year, and the two must not blur in the shop window. The Healing remains in the full catalogue.
- **The Petrosphere Odyssey is unpublished**: finalised but never released, and it is the press's launch title. Its book page carries no Amazon link and no buy buttons. It gets a "coming soon, be first to read it" invitation with the email signup, framed as an invitation, not an apology.
